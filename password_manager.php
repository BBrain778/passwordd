...
if (!isset($_SESSION['logout_time'])) {
    $_SESSION['logout_time'] = time() + 300; // 設定300秒倒數
}
...
<head>
    ...
    <script>
        ...
        window.onload = function() {
            let timeLeft = <?php echo $timeLeft; ?>; // PHP 中的剩餘時間
            ...
            <tbody>
                <?php foreach ($passwords as $entry): ?>
                    <tr>
                        ...
                        <td>
                            <input type="password" id="password-<?php echo $entry['id']; ?>" value="<?php echo htmlspecialchars($entry['decrypted_password']); ?>" readonly>
